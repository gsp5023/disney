...
#define d_m3CommutativeOpMacro_0(RES, REG, TYPE, NAME, OP) \
d_m3Op(TYPE##_##NAME##_rs)                              \
{                                                       \
    TYPE operand = slot (TYPE);                         \
    OP((RES), operand, ((TYPE) REG));                   \
    nextOp ();                                          \
}                                                       \
d_m3Op(TYPE##_##NAME##_ss)                              \
{                                                       \
    TYPE operand2 = slot (TYPE);                        \
    TYPE operand1 = slot (TYPE);                        \
    OP((RES), operand1, operand2);                      \
    nextOp ();                                          \
}

#define d_m3CommutativeOpMacro_1(RES, REG, TYPE, NAME, OP, ARG) \
d_m3Op(TYPE##_##NAME##_rs)                              \
{                                                       \
    TYPE operand = slot (TYPE);                         \
    OP((RES), operand, ((TYPE) REG), ARG);              \
    nextOp ();                                          \
}                                                       \
d_m3Op(TYPE##_##NAME##_ss)                              \
{                                                       \
...
#define d_m3OpMacro_0(RES, REG, TYPE, NAME, OP)         \
d_m3Op(TYPE##_##NAME##_sr)                              \
{                                                       \
    TYPE operand = slot (TYPE);                         \
    OP((RES), ((TYPE) REG), operand);                   \
    nextOp ();                                          \
}                                                       \
d_m3CommutativeOpMacro_0(RES, REG, TYPE,NAME, OP)

#define d_m3OpMacro_1(RES, REG, TYPE, NAME, OP, ARG)    \
d_m3Op(TYPE##_##NAME##_sr)                              \
{                                                       \
    TYPE operand = slot (TYPE);                         \
    OP((RES), ((TYPE) REG), operand, ARG);              \
    nextOp ();                                          \
}                                                       \
d_m3CommutativeOpMacro_1(RES, REG, TYPE,NAME, OP, ARG)
...
#define d_m3OpMacro_i_0(TYPE, NAME, MACRO)                  d_m3OpMacro_0           ( _r0,  _r0, TYPE, NAME, MACRO)
#define d_m3OpMacro_i_1(TYPE, NAME, MACRO, ARG)             d_m3OpMacro_1           ( _r0,  _r0, TYPE, NAME, MACRO, ARG)
...
d_m3OpMacro_i_0(u32, Divide, OP_DIV_U);
d_m3OpMacro_i_1(i32, Divide, OP_DIV_S, INT32_MIN);
d_m3OpMacro_i_0(u64, Divide, OP_DIV_U);
d_m3OpMacro_i_1(i64, Divide, OP_DIV_S, INT64_MIN);

d_m3OpMacro_i_0(u32, Remainder, OP_REM_U);
d_m3OpMacro_i_1(i32, Remainder, OP_REM_S, INT32_MIN);
d_m3OpMacro_i_0(u64, Remainder, OP_REM_U);
d_m3OpMacro_i_1(i64, Remainder, OP_REM_S, INT64_MIN);
...
#define d_m3TruncMacro_0(DEST, SRC, TYPE, NAME, FROM, OP)   \
d_m3Op(TYPE##_##NAME##_##FROM##_r_r)                \
{                                                   \
    OP((DEST), (FROM) SRC);          \
    nextOp ();                                      \
...
#if d_m3HasFloat
d_m3TruncMacro_0(_r0, _fp0, i32, Trunc, f32, OP_I32_TRUNC_F32)
d_m3TruncMacro_0(_r0, _fp0, u32, Trunc, f32, OP_U32_TRUNC_F32)
d_m3TruncMacro_0(_r0, _fp0, i32, Trunc, f64, OP_I32_TRUNC_F64)
d_m3TruncMacro_0(_r0, _fp0, u32, Trunc, f64, OP_U32_TRUNC_F64)

d_m3TruncMacro_0(_r0, _fp0, i64, Trunc, f32, OP_I64_TRUNC_F32)
d_m3TruncMacro_0(_r0, _fp0, u64, Trunc, f32, OP_U64_TRUNC_F32)
d_m3TruncMacro_0(_r0, _fp0, i64, Trunc, f64, OP_I64_TRUNC_F64)
d_m3TruncMacro_0(_r0, _fp0, u64, Trunc, f64, OP_U64_TRUNC_F64)

d_m3TruncMacro_0(_r0, _fp0, i32, TruncSat, f32, OP_I32_TRUNC_SAT_F32)
d_m3TruncMacro_0(_r0, _fp0, u32, TruncSat, f32, OP_U32_TRUNC_SAT_F32)
d_m3TruncMacro_0(_r0, _fp0, i32, TruncSat, f64, OP_I32_TRUNC_SAT_F64)
d_m3TruncMacro_0(_r0, _fp0, u32, TruncSat, f64, OP_U32_TRUNC_SAT_F64)

d_m3TruncMacro_0(_r0, _fp0, i64, TruncSat, f32, OP_I64_TRUNC_SAT_F32)
d_m3TruncMacro_0(_r0, _fp0, u64, TruncSat, f32, OP_U64_TRUNC_SAT_F32)
d_m3TruncMacro_0(_r0, _fp0, i64, TruncSat, f64, OP_I64_TRUNC_SAT_F64)
d_m3TruncMacro_0(_r0, _fp0, u64, TruncSat, f64, OP_U64_TRUNC_SAT_F64)
#endif
...
d_m3Op  (Unreachable)
{
    ...
    debug_write_line("stack backtrace:", ctx->callstack_len);
    for (size_t i = ctx->callstack_len; i > 0; --i) {
        const size_t index = i - 1;
        const size_t depth = ctx->callstack_len - i;
        debug_write_line("%5d: %s", depth, GetFunctionName(ctx->callstack[index]));
    }

    return m3_StoreErrorAndStackTrace(_mem->runtime, m3Err_trapUnreachable);
}
...
#define d_outOfBounds                                                                             \
        m3_StoreErrorAndStackTrace(_mem->runtime, ErrorRuntime (m3Err_trapOutOfBoundsMemoryAccess,\
                        _mem->runtime, "memory size: %zu; access offset: %zu",                    \
                        _mem->length, operand))
#else
#define d_outOfBounds m3_StoreErrorAndStackTrace(_mem->runtime, m3Err_trapOutOfBoundsMemoryAccess)
#endif
