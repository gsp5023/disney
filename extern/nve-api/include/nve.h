...
#include "nve_platform.h"
#include "nve_network_configuration.h"

#include "nve_logging.h"
...
FFI_EXPORT_NVE void nve_get_psdk_version(FFI_PTR_WASM nve_version_t * out_version);
...
// Dispatcher/PSDKEvent:nve_api FFI Methods
...
FFI_EXPORT_NVE void nve_m5_cenc_init_data_get(FFI_PTR_NATIVE void * event_payload_ptr, FFI_PTR_WASM FFI_SINGLE void * out_ptr, FFI_PTR_WASM int32_t * out_size, FFI_PTR_WASM nve_drm_method_e * out_method, FFI_PTR_WASM nve_drm_key_tag_e * out_tag);
...
FFI_EXPORT_NVE double nve_media_player_local_position(FFI_PTR_NATIVE void * player_ptr);
...
void nve_callback_manager_thread_end(nve_handle_t event_manager);
