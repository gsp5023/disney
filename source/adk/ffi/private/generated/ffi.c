...
#include "source/adk/ffi/barrel.h"
#include "source/adk/ffi/private/generated/type_assertions.h"
...
extender_status_e wasm3_link_adk(IM3Module wasm_app_module) {
#define FFI_THUNK(_sig, _ret, _name, _args, _body) \
...
#ifdef _WIN32
DLL_EXPORT const ffi_exports_t adk_ffi_exports = {
#include "source/adk/ffi/private/generated/ffi_thunks.h"
};
DLL_EXPORT const ffi_exports_t * get_adk_ffi_exports() {
    return &adk_ffi_exports;
}
#else
static const ffi_exports_t exports = {
#include "source/adk/ffi/private/generated/ffi_thunks.h"
};
DLL_EXPORT const ffi_exports_t * adk_ffi_exports = &exports;
DLL_EXPORT const ffi_exports_t * get_adk_ffi_exports() {
    return &exports;
}
#endif
