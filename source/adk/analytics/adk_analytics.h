...
#define FFI_EXPORT_CONSOLE_NATIVE FFI_EXPORT FFI_IMPLEMENT_IF_DEF(_CONSOLE_NATIVE)
...
void adk_analytics_destroy(void);

///*****************************
///Analytics Settings
///*****************************
FFI_EXPORT_CONSOLE_NATIVE
...
FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_getway_url(void);

FFI_EXPORT_CONSOLE_NATIVE
uint32_t adk_analytics_get_heartbeat_interval(void);

FFI_EXPORT_CONSOLE_NATIVE
uint32_t adk_analytics_get_player_poll_interval(void);

FFI_EXPORT_CONSOLE_NATIVE
adk_analytics_log_e adk_analytics_get_log_level(void);

FFI_EXPORT_CONSOLE_NATIVE
bool adk_analytics_get_enable_player_state_inference(void);
...
FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_asset_name(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_default_cdn(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_default_resource(void);

FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_get_default_bitrate(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_viewer_id(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_player_name(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE char * adk_analytics_get_stream_url(void);

FFI_EXPORT_CONSOLE_NATIVE
bool adk_analytics_get_is_live(void);

FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_get_duration(void);
...
///*****************************
FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_device_brand(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_device_manufacturer(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_device_model(void);

FFI_EXPORT_CONSOLE_NATIVE
Device adk_analytics_get_device_type(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_device_version(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_framework_name(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_framework_version(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_operating_system_name(void);

FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_operating_system_version(void);
...
FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_create_session(void);
...
FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_get_playahead_time(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_get_buffer_length(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
float adk_analytics_get_rendered_framerate(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
int32_t adk_analytics_get_min_buffer_length(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_player_type(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
FFI_PTR_NATIVE const char * adk_analytics_get_player_version(const int32_t session_id);
FFI_EXPORT_CONSOLE_NATIVE
...
FFI_EXPORT_CONSOLE_NATIVE
void adk_analytics_create_dictionary(void);

FFI_EXPORT_CONSOLE_NATIVE
void adk_analytics_destroy_dictionary(void);
...
#undef FFI_EXPORT_CONSOLE_NATIVE
