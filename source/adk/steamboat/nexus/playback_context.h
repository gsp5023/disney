...
public:
    ...
    uint64_t last_video_fragment_time[MAX_MOSAICS];
    uint64_t last_audio_fragment_time[MAX_MOSAICS];

    bool bypassAudio;
    bool perf;
    bool h265Video;
    bool perfFailed;
    unsigned long sizeDecryptedVideo;
    unsigned long timeDecryptVideo;
    unsigned long timeProcessSample;
    unsigned numSamplesDecryptVideo;
    unsigned numSubSamplesDecryptVideo;
};
