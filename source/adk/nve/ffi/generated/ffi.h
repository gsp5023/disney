...
#include "source/adk/nve/ffi/barrel.h"
#include "source/adk/nve/ffi/generated/type_assertions.h"
...
#include "source/adk/nve/ffi/generated/ffi_thunks.h"
#undef FFI_THUNK
...
extender_status_e wasm3_link_nve(IM3Module wasm_app_module) {
#define FFI_THUNK(_sig, _ret, _name, _args, _body) \
...
#define RET_WASM_PTR(_v) RET_I32(_v)
    ...
    switch (sig) {
#include "source/adk/nve/ffi/generated/wasm3_dispatcher.h"
        default: {
...
#include "source/adk/nve/ffi/generated/wamr_dispatcher.h"
#undef FFI_THUNK

extender_status_e wamr_link_nve(wasm_exec_env_t env) {
#define FFI_THUNK(_sig, _ret, _name, _args, _body) \
...
#ifdef _WIN32
DLL_EXPORT const ffi_exports_t nve_ffi_exports = {
#include "source/adk/nve/ffi/generated/ffi_thunks.h"
};
DLL_EXPORT const ffi_exports_t * get_nve_ffi_exports() {
    return &nve_ffi_exports;
}
#else
static const ffi_exports_t exports = {
#include "source/adk/nve/ffi/generated/ffi_thunks.h"
};
DLL_EXPORT const ffi_exports_t * nve_ffi_exports = &exports;
DLL_EXPORT const ffi_exports_t * get_nve_ffi_exports() {
    return &exports;
}
#endif
