...
static const char canvas_sdf_rect_border_frag_bytes[] = 
"#version 100\n"
...
"}\n"
;
static const const_mem_region_t canvas_sdf_rect_border_frag_program = {{.ptr = canvas_sdf_rect_border_frag_bytes}, .size = ARRAY_SIZE(canvas_sdf_rect_border_frag_bytes)};
