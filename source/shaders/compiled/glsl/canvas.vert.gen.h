...
static const char canvas_vert_bytes[] = SHADER_DECLARATION(
\n#version 100\n
...
static const const_mem_region_t canvas_vert_program = {{.ptr = canvas_vert_bytes}, .size = ARRAY_SIZE(canvas_vert_bytes)};
