...
static const char canvas_alpha_test_rgb_fill_alpha_red_frag_bytes[] = SHADER_DECLARATION(
\n#version 100\n
...
static const const_mem_region_t canvas_alpha_test_rgb_fill_alpha_red_frag_program = {{.ptr = canvas_alpha_test_rgb_fill_alpha_red_frag_bytes}, .size = ARRAY_SIZE(canvas_alpha_test_rgb_fill_alpha_red_frag_bytes)};
